            ...
            <div className="row align-center">
                <div className="col-6 left-col">
                    <h1 className="font-weight-bold line-height-1">
                        Forget The Busy Work, <br />Start Your Next Vacation
                    </h1>
                    <p>
                        We provide what you need to enjoy your holiday with
                        family. Time to make another memorable moments.
                        Your money can return, but your time not. What are you thinking?
                    </p>
                    <Button className="btn" isPrimary={true} hasShadow={true} onClick={showMostPicked}>
                        Show Me Now
                    </Button>
                ...
                <div className="col-6 right-col d-flex align-items-end">
                    <div className="image-hero">
                        <img src={ImageHero} alt="" className="hero" />
                    </div>
                    <div className="img-frame">
                        <img src={ImageHeroFrame} alt="" className="frame" />
                    </div>
                </div>
            </div>
        </section>
